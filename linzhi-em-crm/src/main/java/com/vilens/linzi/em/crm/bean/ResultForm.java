...
public class ResultForm<T> implements Serializable {
    ...
    public static <T> ResultForm<T> createErrorAuthResultForm(T result, String... messages) {
        return createResultForm(ResultEnum.auth, result, MessageEnum.auth, messages);
    }
