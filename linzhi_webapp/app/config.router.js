        ...
        [
            ...
            function ($stateProvider, $urlRouterProvider) {
                ...
                $stateProvider
                    ...
                    .state('app.projectList', {
                        ...
                        resolve: {
                            deps: [
                                '$ocLazyLoad',
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load(['pagination', 'toaster']).then(
                                        function () {
                                            return $ocLazyLoad.load({
                                                serie: true,
                                                files: [
                    ...
                    .state('app.exportReport', {
                        url: '/exportReport',
                        templateUrl: 'views/exportReport.html',
                        ncyBreadcrumb: {
                            label: '项目列表'
                        },
                        resolve: {
                                            ...
                                            return $ocLazyLoad.load(
                                                {
                                                    serie: true,
                                                    files: [
                                                        'assets/plugins/datetime/bootstrap-datetimepicker.js',
                                                        'assets/plugins/datetime/locales/bootstrap-datetimepicker.zh-CN.js',
                                                        'assets/plugins/datetime/bootstrap-datetimepicker.css',
                                                        'app/controllers/exportReport.js'
                                                    ]
                                                });
                                        }
                                    );
