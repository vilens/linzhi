    ...
    return {
        ...
        link: function (scope, el, attr, toaster) {
            ...
            CKEDITOR.instances['editor'].on('instanceReady', function (e) {
                ...
                $("#cke_76").before('<a id="cke_75" class="cke_button cke_button__image cke_button_off"  title="图像" tabindex="-1" hidefocus="true" role="button" aria-labelledby="cke_75_label" aria-describedby="cke_75_description" aria-haspopup="false" ' +
                    'onclick="getFile()">' +
